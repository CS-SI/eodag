...
class TestCore(TestCoreBase):
    SUPPORTED_PRODUCT_TYPES = {
        ...
        "LANDSAT_C2L1": ["usgs_satapi_aws", "astraea_eod", "usgs"],
        "LANDSAT_C2L2": ["usgs"],
        ...
        "S3_LAN": ["onda", "creodias"],
        "S3_SRA": ["onda", "creodias"],
        "S3_SRA_BS": ["onda", "creodias"],
        "S3_SRA_A_BS": ["onda", "creodias"],
        "S3_WAT": ["onda", "creodias"],
        "S3_OLCI_L2LFR": ["onda", "creodias", "mundi"],
        "S3_OLCI_L2LRR": ["onda", "creodias"],
        "S3_SLSTR_L1RBT": ["onda", "creodias"],
        "S3_SLSTR_L2LST": ["onda", "creodias"],
        "PLD_PAN": ["theia"],
        "PLD_XS": ["theia"],
        "PLD_BUNDLE": ["theia"],
