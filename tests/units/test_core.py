...
class TestCore(TestCoreBase):
    SUPPORTED_PRODUCT_TYPES = {
        ...
        "CMEMS_GLOBAL_PHY": ["wekeo"],
        "CMEMS_GLOBAL_BGC": ["wekeo"],
        "CMEMS_GLOBAL_WAV": ["wekeo"],
        "CMEMS_GLOBAL_MULTIYEAR_BGC": ["wekeo"],
        "CMEMS_GLOBAL_MULTIYEAR_WAV": ["wekeo"],
        "CMEMS_GLOBAL_MULTIYEAR_PHY": ["wekeo"],
        "CMEMS_MULTIOBS_GLO_BIO_BGC_3D_REP": ["wekeo"],
        "CMEMS_MULTIOBS_GLO_BGC_NUTRIENTS_CARBON": ["wekeo"],
        "CMEMS_MULTIOBS_GLO_PHY_MY": ["wekeo"],
        "CMEMS_MULTIOBS_GLO_PHY_NRT": ["wekeo"],
        "CMEMS_MULTIOBS_GLO_PHY_SSS_L3_MYNRT": ["wekeo"],
        "CMEMS_MULTIOBS_GLO_PHY_TSUV_3D_MYNRT": ["wekeo"],
        "CMEMS_MULTIOBS_GLO_PHY_W_3D_REP": ["wekeo"],
        "CMEMS_MULTIOBS_GLO_BIO_CARBON_SURFACE_REP": ["wekeo"],
        "CMEMS_OCEANCOLOUR_GLO_BGC_L3_NRT_PLANKTON": ["wekeo"],
        "CMEMS_OCEANCOLOUR_GLO_BGC_L3_NRT_OPTICS": ["wekeo"],
        "CMEMS_OCEANCOLOUR_GLO_BGC_L3_MY_PLANKTON": ["wekeo"],
        "CMEMS_OCEANCOLOUR_GLO_BGC_L3_MY_OPTICS": ["wekeo"],
        "CMEMS_OCEANCOLOUR_GLO_BGC_L4_NRT_PLANKTON": ["wekeo"],
        "CMEMS_OCEANCOLOUR_GLO_BGC_L4_NRT_OPTICS": ["wekeo"],
        "CMEMS_OCEANCOLOUR_GLO_BGC_L4_MY_PLANKTON": ["wekeo"],
        "CMEMS_OCEANCOLOUR_GLO_BGC_L4_MY_OPTICS": ["wekeo"],
        "CMEMS_OCEANCOLOUR_GLO_BGC_L4_MY_MONTHLY": ["wekeo"],
        "CMEMS_OCEANCOLOUR_GLO_BGC_L3_MY_DAILY_PLANKTON": ["wekeo"],
        "CMEMS_OCEANCOLOUR_GLO_BGC_L3_MY_DAILY_REFLECTANCE": ["wekeo"],
        "CMEMS_GLO_SEAICE_L4_NRT_CONC": ["wekeo"],
        "CMEMS_GLO_SEAICE_L4_NRT_EDGE": ["wekeo"],
        "CMEMS_GLO_SEAICE_L4_NRT_TYPE": ["wekeo"],
        "CMEMS_GLO_SEAICE_L4_NRT_DRIFT": ["wekeo"],
        "CMEMS_GLO_SEAICE_DRIFT_SAR": ["wekeo"],
        "CMEMS_GLO_SEAICE_CONC_REP": ["wekeo"],
        "CMEMS_GLO_SEALEVEL_PHY_L4_NRT": ["wekeo"],
        "CMEMS_GLO_SEALEVEL_PHY_MDT": ["wekeo"],
        "CMEMS_GLO_SST_L3S_NRT": ["wekeo"],
        "CMEMS_GLO_SST_L4_NRT": ["wekeo"],
        "CMEMS_GLO_SST_L4_REP": ["wekeo"],
        "CMEMS_GLO_SST_L4_REP_CCI": ["wekeo"],
        "CMEMS_GLO_SST_L4_REP_C3S": ["wekeo"],
        "CMEMS_GLO_WAVE_SPC_L4_NRT": ["wekeo"],
        "CMEMS_GLO_WAVE_SWH_L3_NRT": ["wekeo"],
        "CMEMS_GLO_WAVE_SWH_L4_NRT": ["wekeo"],
        "CMEMS_GLO_WIND_L4_NRT": ["wekeo"],
        "CMEMS_GLO_WIND_L4_MY": ["wekeo"],
        "CMEMS_GLO_WIND_L3_NRT": ["wekeo"],
        "CMEMS_GLO_WIND_L3_REP": ["wekeo"],
