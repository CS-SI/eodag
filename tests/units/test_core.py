...
class TestCore(TestCoreBase):
    SUPPORTED_PRODUCT_TYPES = {
        ...
        "S3_SLSTR_L2": ["wekeo"],
        "S3_SLSTR_L2AOD": ["cop_dataspace", "creodias", "creodias_s3", "eumetsat_ds", "sara"],
        "S3_SLSTR_L2FRP": ["cop_dataspace", "creodias", "creodias_s3", "eumetsat_ds", "onda", "sara"],
        "S3_SLSTR_L2LST": ["cop_dataspace", "creodias", "creodias_s3", "onda", "sara"],
        "S3_SLSTR_L2WST": ["cop_dataspace", "creodias", "creodias_s3", "eumetsat_ds", "onda", "sara"],
        "S3_SRA": [
            "cop_dataspace",
            "creodias",
            "creodias_s3",
