...
class TestCore(TestCoreBase):
    SUPPORTED_PRODUCT_TYPES = {
        ...
        "S1_SAR_OCN": ["creodias", "mundi", "onda", "peps", "sara"],
        "S1_SAR_RAW": ["creodias", "mundi", "onda"],
        "S1_SAR_SLC": ["creodias", "mundi", "onda", "peps", "sara"],
        "S2_MSI_L1C": [
            "astraea_eod",
            "aws_eos",
            "creodias",
        ...
        "S3_EFR": ["creodias", "mundi", "onda", "sara"],
        "S3_ERR": ["creodias", "mundi", "onda", "sara"],
        "S3_LAN": ["creodias", "mundi", "onda", "sara"],
        "S3_OLCI_L2LFR": ["creodias", "mundi", "onda", "sara"],
        "S3_OLCI_L2LRR": ["creodias", "mundi", "onda", "sara"],
        "S3_OLCI_L2WFR": ["creodias", "onda", "sara"],
        "S3_OLCI_L2WRR": ["creodias", "onda", "sara"],
        "S3_RAC": ["sara"],
        "S3_SLSTR_L1RBT": ["creodias", "mundi", "onda", "sara"],
        "S3_SLSTR_L2AOD": ["creodias", "sara"],
        "S3_SLSTR_L2FRP": ["creodias", "mundi", "onda", "sara"],
        "S3_SLSTR_L2LST": ["creodias", "mundi", "onda", "sara"],
        "S3_SLSTR_L2WST": ["creodias", "onda", "sara"],
        "S3_SRA": ["creodias", "mundi", "onda", "sara"],
        "S3_SRA_A": ["creodias", "mundi", "onda", "sara"],
        "S3_SRA_BS": ["creodias", "mundi", "onda", "sara"],
        "S3_SY_AOD": ["creodias", "onda", "sara"],
        "S3_SY_SYN": ["creodias", "mundi", "onda", "sara"],
        "S3_SY_V10": ["creodias", "mundi", "onda", "sara"],
        "S3_SY_VG1": ["creodias", "mundi", "onda", "sara"],
        "S3_SY_VGP": ["creodias", "mundi", "onda", "sara"],
        "S3_WAT": ["creodias", "onda", "sara"],
        "S5P_L1B_IR_SIR": ["creodias", "mundi"],
        "S5P_L1B_IR_UVN": ["creodias", "mundi"],
        "S5P_L1B_RA_BD1": ["creodias", "mundi", "onda"],
        "S5P_L1B_RA_BD2": ["creodias", "mundi", "onda"],
        "S5P_L1B_RA_BD3": ["creodias", "mundi", "onda"],
        "S5P_L1B_RA_BD4": ["creodias", "mundi", "onda"],
        "S5P_L1B_RA_BD5": ["creodias", "mundi", "onda"],
        "S5P_L1B_RA_BD6": ["creodias", "mundi", "onda"],
        "S5P_L1B_RA_BD7": ["creodias", "mundi", "onda"],
        "S5P_L1B_RA_BD8": ["creodias", "mundi", "onda"],
        "S5P_L2_AER_AI": ["creodias", "mundi", "onda"],
        "S5P_L2_AER_LH": ["creodias", "mundi", "onda"],
        "S5P_L2_CH4": ["creodias", "mundi", "onda"],
        "S5P_L2_CLOUD": ["creodias", "mundi", "onda"],
        "S5P_L2_CO": ["creodias", "mundi", "onda"],
        "S5P_L2_HCHO": ["creodias", "mundi", "onda"],
        "S5P_L2_NO2": ["creodias", "mundi", "onda"],
        "S5P_L2_NP_BD3": ["creodias", "mundi", "onda"],
        "S5P_L2_NP_BD6": ["creodias", "mundi", "onda"],
        "S5P_L2_NP_BD7": ["creodias", "mundi", "onda"],
        "S5P_L2_O3": ["creodias", "mundi", "onda"],
        "S5P_L2_O3_PR": ["creodias", "mundi", "onda"],
        "S5P_L2_O3_TCL": ["creodias", "mundi"],
        "S5P_L2_SO2": ["creodias", "mundi", "onda"],
        "SPOT5_SPIRIT": ["theia"],
        "SPOT_SWH": ["theia"],
        "SPOT_SWH_OLD": ["theia"],
        "TIGGE_CF_SFC": ["ecmwf"],
