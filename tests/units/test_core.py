...
class TestCore(TestCoreBase):
    SUPPORTED_PRODUCT_TYPES = {
        ...
        "EFAS_FORECAST": ["cop_ewds", "dedl", "wekeo_ecmwf"],
        "EFAS_HISTORICAL": ["cop_ewds", "dedl", "wekeo_ecmwf"],
        "EFAS_REFORECAST": ["cop_ewds", "dedl", "wekeo_ecmwf"],
        "EFAS_SEASONAL": ["cop_ewds", "dedl", "wekeo_ecmwf"],
        "EFAS_SEASONAL_REFORECAST": ["cop_ewds", "dedl", "wekeo_ecmwf"],
        ...
        "GLOFAS_FORECAST": ["cop_ewds", "dedl", "wekeo_ecmwf"],
        "GLOFAS_HISTORICAL": ["cop_ewds", "dedl", "wekeo_ecmwf"],
        "GLOFAS_REFORECAST": ["cop_ewds", "dedl", "wekeo_ecmwf"],
        "GLOFAS_SEASONAL": ["cop_ewds", "dedl", "wekeo_ecmwf"],
        "GLOFAS_SEASONAL_REFORECAST": ["cop_ewds", "dedl", "wekeo_ecmwf"],
