...
class TestCore(TestCoreBase):
    SUPPORTED_PRODUCT_TYPES = {
        ...
        "S3_EFR": ["cop_dataspace", "creodias", "mundi", "onda", "sara", "wekeo"],
        "S3_ERR": ["cop_dataspace", "creodias", "mundi", "onda", "sara", "wekeo"],
        "S3_LAN": ["cop_dataspace", "creodias", "mundi", "onda", "sara", "wekeo"],
        "S3_OLCI_L2LFR": [
            "cop_dataspace",
            "creodias",
            "mundi",
        ...
        "S3_SRA": ["cop_dataspace", "creodias", "mundi", "onda", "sara", "wekeo"],
        "S3_SRA_A": ["cop_dataspace", "creodias", "mundi", "onda", "sara", "wekeo"],
        "S3_SRA_BS": ["cop_dataspace", "creodias", "mundi", "onda", "sara", "wekeo"],
        "S3_SY_AOD": ["cop_dataspace", "creodias", "onda", "sara"],
        "S3_SY_SYN": ["cop_dataspace", "creodias", "mundi", "onda", "sara", "wekeo"],
        ...
        "S3_OLCI_L2WFR_REPROCESSED": ["wekeo"],
        "S3_OLCI_L2WRR_REPROCESSED": ["wekeo"],
        "S3_SRA_1A_REPROCESSED": ["wekeo"],
        "S3_SRA_1B_REPROCESSED": ["wekeo"],
        "S3_SRA_1B_SE_REPROCESSED": ["wekeo"],
        "S3_WAT_REPROCESSED": ["wekeo"],
        "S3_SLSTR_L1RBT_REPROCESSED": ["wekeo"],
        "S3_SLSTR_L2WST_REPROCESSED": ["wekeo"],
