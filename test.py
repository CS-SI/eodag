...
product_types = dag.list_product_types(provider="planetary_computer")
# product_types = dag.list_product_types(provider="peps")
...
# product_types = dag.list_product_types(provider="cop_dataspace")
...
#     )
# products = dag.search(
#     productType='DAILY_FILES_ACTIVE_V05.3',
#     provider="fedeo_ceda",
# )
# products = dag.search(
...
kwargs = {
    "id": "S2A_MSIL2A_20251007T102931_R108_T32TMT_20251007T142913",
}
products = dag.search(
...
# geom = {
#     "lonmin": -74.49554443359376,
#     "latmin": 40.6634520233717,
#     "lonmax": -74.33795928955081,
#     "latmax": 40.782881118849616
# }
...
#     print(product.properties["storageStatus"])

# output_dir = pathlib.Path("/home/tlarrouy/eodag/download")
# output_dir.mkdir(exist_ok=True)

# for i, product in enumerate(products):  # limiter à 10 images
#     quicklook_url = product.properties.get("quicklook")
#     title = product.properties.get("title", f"product_{i+1}")

#     if quicklook_url:
#         r = requests.get(quicklook_url)
#         if r.status_code == 200:
#             file_path = output_dir / f"{title}_quicklook.jpg"
#             file_path.write_bytes(r.content)
#             print(f"{title} → Quicklook téléchargé")
#         else:
#             print(f"Échec pour {title} ({r.status_code})")
#     else:
#         print(f"Pas de quicklook pour {title}")
