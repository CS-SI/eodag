...
explain how they should be used. Each page is a `Jupyter notebook <https://jupyter.org/>`_ can be viewed online,
...
.. note::
   ...
   You should be registered to *PEPS* to run a few notebooks.
   See :ref:`configure` and :ref:`register`.

.. warning::

   The `Download <notebooks/api_user_guide/download.ipynb>` notebook involved downloading a few
