...
* `ads`: create an account `here <https://ads.atmosphere.copernicus.eu/user/register>`__.
...
* `cds`: create an account `here <https://cds.climate.copernicus.eu/user/register>`__.
