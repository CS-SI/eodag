...
class Provider:
    ...
    :param config: Provider configuration as :meth:`~eodag.config.ProviderConfig` instance or :class:`dict`
...
class ProvidersDict(UserDict[str, Provider]):
    ...
    def configs(self) -> dict[str, ProviderConfig]:
        ...
        :return: Dictionary mapping provider name to :class:`~eodag.config.ProviderConfig`.
        """
