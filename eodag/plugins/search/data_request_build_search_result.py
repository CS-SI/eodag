...
logger = logging.getLogger("eodag.apis.polytope")
...
class DataRequestBuildSearchResult(BuildPostSearchResult):
    ...
    def do_search(self, *args, **kwargs):
        ...
        self.request_params = format_query_params(product_type, self.config, **keywords)
        ...
        request = requests.Request(
            method="POST", url=request_url, headers=request_header, json=request_body
        )
